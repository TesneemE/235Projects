...
/**
  @pre: This function is called to clear the Character's action queue
  @post: Clears action_queue_
*/
...
/**
  @pre: This function is called to get the action_queue_ of a character
  @return: the Character's action_queue
*/
...
/**
  @pre: This function is called to insert a value into the action_queue
  @param: an int value
  @post: inserts given int value into the back of the action_queue
*/
void Character::enqueueActionQueue(int action)
{
    action_queue_.push(action);
}

/**
  @pre: This function is called to dequeue the action_queue_ of a character
  @post: pops the value at the front of the action_queue
*/
void Character::dequeueActionQueue()
{
    action_queue_.pop();
}

/**
  @pre: This function is called to get the buff_stack_ of a character
  @return: the Character's buff_stack_
*/
